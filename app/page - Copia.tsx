...
export default function LandingPage() {
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 bg-white rounded-2xl shadow-2xl p-10 max-w-md w-full mx-4 text-center">
          {logo_url ? (
            <img src={logo_url} alt={name} className="h-16 mx-auto mb-6 object-contain" />
          ) : (
            <div
              className="h-16 w-16 rounded-xl mx-auto mb-6 flex items-center justify-center text-white text-2xl font-bold"
              style={{ backgroundColor: primary_color || '#3B82F6' }}
            >
          ...
          <Link
            href="/login"
            className="block w-full py-3 px-6 rounded-xl text-white font-semibold text-lg transition-all hover:opacity-90 hover:shadow-lg text-center"
            style={{ backgroundColor: primary_color || '#3B82F6' }}
          >
            Entrar na conta
          </Link>
          <p className="text-xs text-gray-400 mt-8">
            Powered by <span className="font-medium">MeuDashboard</span>
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-100 p-4">
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md text-center">
          ...
          <Link href="https://meudashboard.org" className="text-blue-600 hover:underline">
            Ir para MeuDashboard
          </Link>
        </div>
      </div>
    );
  ...
  // Sem subdomínio: landing principal
  return (
          ...
          <div className="relative bg-gradient-to-br from-slate-100 via-white to-slate-50 rounded-3xl p-12 text-center border border-slate-200 shadow-xl overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/cadastro" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 hover:shadow-xl">
                  Acessar plataforma
                </Link>
              </div>
            </div>
